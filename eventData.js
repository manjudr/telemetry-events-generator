...
function getUserAgent() {
    ...
    const selectedUA = faker.random.arrayElement(userAgentList);
    const userAgent = deviceDetector.parse(selectedUA);
    return {
        agent: userAgent.client.name,
        ver: userAgent.client.version,
        system: userAgent.os.name,
        platform: userAgent.client.engine,
        raw: selectedUA,
    };
}
